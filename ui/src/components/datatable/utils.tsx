...
export const postManagementColumn: GridColDef[] = [
	...
	{ field: "title", headerName: "Title", width: 300, resizable: true, renderCell: (param) => <div onClick={() => console.log("hello")} style={{ cursor: "pointer", textDecoration: "underline" }}>{param.value}</div> },
